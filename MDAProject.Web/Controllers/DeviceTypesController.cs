...
namespace MDAProject.Web.Controllers
{
    public class DeviceTypesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,DeviceTypeName")] DeviceType deviceType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,DeviceTypeName")] DeviceType deviceType)
        {
            if (id != deviceType.Id)
            {
                return NotFound();
